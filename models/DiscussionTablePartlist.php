...
Yii::import('application.models._base.BaseDiscussionTablePartlist');

class DiscussionTablePartlist extends BaseDiscussionTablePartlist {
    ...
    /** @param DiscussionTable $bt	 */
    public function getParts($dt) {
        return $this->include_table ? $dt->getParts($this->units_per_cluster) : array();
    }
