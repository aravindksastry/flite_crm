...
Yii::import('application.models._base.BaseAccessoryPartlist');

class AccessoryPartlist extends BaseAccessoryPartlist {
    ...
    /** @param Accessory $acc	 */
    public function getParts($acc) {
        return $this->include_table ? $acc->getParts() : array();
    }
