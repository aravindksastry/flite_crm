...
Yii::import('application.models._base.BaseBoardRoomTablePartlist');

class BoardRoomTablePartlist extends BaseBoardRoomTablePartlist {
    ...
    /** @param BoardRoomTable $bt	 */
    public function getParts($bt) {
        return $this->include_table ? $bt->getParts($this->units_per_cluster) : array();
    }
